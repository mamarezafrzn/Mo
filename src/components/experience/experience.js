  ...
  return (
    <div className="bg-[#e2cbd02b] rounded-xl lg-p-[1rem]">
      {t.main.experience.list.map((item) => (
        <div
          key={item.title}
          className="hover:outline hover:outline-[#e2cbd0] mb-[0.5rem] p-[1rem] rounded-xl flex flex-col gap-[1rem]"
        >
